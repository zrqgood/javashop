...
/**
 * 
 * 可插件化业务基类,提供插件桩基本功能<br/> 本类首先继承了 BaseManager，具有操作数据库的能力。<br/>
 * 本类实现了IPluginBundle接口，使其具有了插件桩化的能力。<br/>
 ...
 * 
 */
public abstract class AbstractDBPluginsBundle  implements
		IPluginBundle {

	protected static final Log loger = LogFactory
			.getLog(AbstractDBPluginsBundle.class);

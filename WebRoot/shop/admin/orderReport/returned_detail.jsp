...
<table class="form-table">
	<tr>
		<th>退货单号：</th><td>${delivery.delivery_id }</td>
	...
	<tr>
		...
		<th>退货人:</th><td>${delivery.ship_name }</td>
	</tr>
	<tr>
		<th>退货地区:</th><td>${delivery.province }-${delivery.city }-${delivery.region }</td>
		<th>退货地址:</th><td>${delivery.ship_addr }</td>

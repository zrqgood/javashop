			...
			<tbody>
				<tr>
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%">
						<tbody>
							<tr>
								<td><span style="font-family: EanP36Tt; font-size: 48px;">${ord.sn
								}</span></td>
								<td>
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			...
			<c:forEach items="${itemList}" var="item" varStatus="index">
				<tr>
					<td>${index.index + 1 }</td>
					<td>${item.sn }</td>
					<td><img class="product" src="${item.image }" width="50"
						height="50" align="absmiddle" />${item.name }</td>

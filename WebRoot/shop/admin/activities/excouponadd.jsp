    ...
    <div class="division">
      <table class="form-table">
        <tbody><tr>
          ...
          <td>      
            <select name="cpnsid">
            	<c:forEach items="${listCanExchange }" var="exchange">
            		<option value="${exchange.cpns_id }">${exchange.cpns_name }</option>
            	</c:forEach>
            </select>
        ...
        <tr>
          <th>积分兑换数额：</th>
           <td><input type="text" required="true" name="point" style="width: 50px;" dataType="int"> &nbsp; &nbsp; 			<span id="el_1">
